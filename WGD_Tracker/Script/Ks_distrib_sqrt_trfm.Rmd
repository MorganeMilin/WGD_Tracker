...
```{r, echo=F}
data2_sqrt <- data2
data2_sqrt$Node.Ks <- sqrt(data2_sqrt$Node.Ks)
summary(data2_sqrt)
```
\rule{1\linewidth}{0.5pt}
...
for (i in kmin:kmax){
	...
	mix.object = normalmixEM(data2_sqrt$Node.Ks, lambda = NULL, mu = NULL, sigma = NULL, k = i, epsilon = epsilon)
	...
	params = data.frame(i, centers^2, stdevs^2, contribs, loglik)
